...
export const BUILDERS = {
  ...
  holdfast: {
    landmark: buildHoldfastKeepLandmark,
    ...
    body(api) {
      ...
      // One courtyard surface, with a real opening around the descending sealed stair.
      for (const [x0,x1,z0,z1] of [[-61.38,41.5,-63.38,59.38],[48.5,61.38,-63.38,59.38],[41.5,48.5,-63.38,-47.5],[41.5,48.5,-36,59.38]])
        s.quad(x1-x0,z1-z0,(x0+x1)/2,y+ON_APRON,(z0+z1)/2,[0.052,0.051,0.049],0,-Math.PI*0.5);
