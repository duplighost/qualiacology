...
export function installStationFloor(material){
  ...
  material.onBeforeCompile=shader=>{
    ...
    shader.fragmentShader=shader.fragmentShader
      ...
      .replace('#include <roughnessmap_fragment>',`
        ...
        float workshopFloor=workshopInside.x*workshopInside.y*smoothstep(0.72,0.96,vWxUp)
          *smoothstep(0.0,0.035,workshopUv.y)*(1.0-countySnowCover);
  ...
  material.customProgramCacheKey=()=>key+'-workshop-wear-1';
