...
const LIGHTING = guardPointLightLoop(THREE.ShaderChunk.lights_fragment_begin
...
export function readableSurface(material){
  ...
  material.customProgramCacheKey=()=> 'wwpm-near-surface-v2';
  return material;
}
...
export function skinSurface(material){
  ...
  material.customProgramCacheKey=()=> 'wwpm-skin-v3';
  return material;
}
