...
export const TRIAL_DESTS = [
  ...
  make({ id: 'ashenamphitheater', region: 'ember', x: -410, z: -220, y: 8.8, name: 'Ashen Amphitheater', layout: 'amphitheater',
  ...
  make({ id: 'bluewake', region: 'frost', x: -510, z: -180, y: 3.2, name: 'Bluewake Gallery', layout: 'causeway',
  ...
  make({ id: 'mirrortarn', region: 'frost', x: -40, z: -430, y: 6.8, name: 'Mirror Tarn', layout: 'prismtarn',
  ...
  make({ id: 'sporeorchard', region: 'mycel', x: 230, z: 160, y: 3.2, name: 'Spore Orchard', layout: 'sporeorchard',
  ...
  make({ id: 'rootlung', region: 'mycel', x: 330, z: 50, y: 2.8, name: 'Rootlung Labyrinth', layout: 'rootlung',
  ...
  make({ id: 'capcathedral', region: 'mycel', x: 540, z: -170, y: 4.0, name: 'Cathedral of Caps', layout: 'capcathedral',
